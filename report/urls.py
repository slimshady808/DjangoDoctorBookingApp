...
urlpatterns = [
    ...
    path('test-titles/',views.TestTitlesListCreateView.as_view(),name="testtitle-list-create"),
    path('test-titles/<int:pk>/',views.TestTitlesRetrieveUpdateDeleteView.as_view(),name='testtitle-detail')
]